...
from static import not_even_or_odd_periodic_func, t, gap_start, gap_end, gap_end_val, gap_length, N, N_1, N_2, N_3, N_4, N_5
...
a_N = calcs.calc_a_n(N, gap_start, gap_end, gap_length, not_even_or_odd_periodic_func)
if (not isinstance(a_N, int)):
    a_N = a_N.evalf()

b_N = calcs.calc_b_n(N, gap_start, gap_end, gap_length, not_even_or_odd_periodic_func)
if (not isinstance(b_N, int)):
    b_N = b_N.evalf()

c_N = calcs.calc_c_n(N, gap_start, gap_end, gap_length, not_even_or_odd_periodic_func)
