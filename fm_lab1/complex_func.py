...
build_par_G_N__par_cf_t(N_1, gaps, funcs, funcs_t)
build_par_G_N__par_cf_t(N_2, gaps, funcs, funcs_t)
build_par_G_N__par_cf_t(N_3, gaps, funcs, funcs_t)
build_par_G_N__par_cf_t(N_4, gaps, funcs, funcs_t)
