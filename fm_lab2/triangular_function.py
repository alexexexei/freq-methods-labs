from static import triangular_function, a_b_pars, intervals, colors_strs
from builder import build_f_t, build_fimg

f_t_1 = triangular_function(a_b_pars[0][0], a_b_pars[0][1])
f_t_2 = triangular_function(a_b_pars[1][0], a_b_pars[1][1])
f_t_3 = triangular_function(a_b_pars[2][0], a_b_pars[2][1])
